...
heroImage: '../../assets/images/te.jpg' # Kept as in the original template
...
Here are some example tags that will be used elsewhere in the blog:

<div style="display: flex; gap: 10px; margin-top: 10px;">
  <button style="background-color: #f0f0f0; border: none; padding: 5px 10px; border-radius: 5px; cursor: pointer; font-size: 14px;">AI</button>
  <button style="background-color: #f0f0f0; border: none; padding: 5px 10px; border-radius: 5px; cursor: pointer; font-size: 14px;">Sales</button>
  <button style="background-color: #f0f0f0; border: none; padding: 5px 10px; border-radius: 5px; cursor: pointer; font-size: 14px;">Technology</button>
  <button style="background-color: #f0f0f0; border: none; padding: 5px 10px; border-radius: 5px; cursor: pointer; font-size: 14px;">Coding</button>
  <button style="background-color: #f0f0f0; border: none; padding: 5px 10px; border-radius: 5px; cursor: pointer; font-size: 14px;">Personal Stories</button>
</div>
